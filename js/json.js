...
*/
       ...
       var tool_icons = "<div id='righterr' class='grid-container' style='display:block;'>" + "<ul class='col-md-3'>" + "<li style='list-style-type: none;' class = 'bor' >" +  "<div class = 'smile'>" +  "<a href='#'>" + "<img src='img/arrow_up_1.png' align='center''/>" + "</a>" + "<a href='http://google.com'>" + "<img class = 'ver' src='img/play.png' />" + "</a>" + "<a href='http://google.com'>" + "<img class = 'ver' src='img/eye.png' align='center''/>" + "</a> " + "<a href='http://google.com'>" +"<img  class = 'ver' src='img/quality.png' align='center''/>" + "</a>" + "<a href='http://google.com'>" + "<img src='img/support.png' align='center''/>" + "</a>" +  "<a href='http://google.com'>" + "<img src='img/docker-whale.png' align='center''/>" + "</a>"  +  "<a href='#'>" + "<img src='img/arrow_down_2.png' align='center''/>" + "</a>" + "</div>" + "</li>" + "</ul>" + "</div>"
		 //+  "<a href='http://google.com'>" + "<img src='img/docker-whale.png' align='center''/>" + "</a>"  -- Docker icon!
		  //+  "<a href='http://google.com'>" + "<img src='img/arrow_down_2.png' align='center''/>" + "</a>"  -- up icon!
		   //+  "<a href='http://google.com'>" + "<img src='img/arrow_up_1.png' align='center''/>" + "</a>"  -- down icon!
